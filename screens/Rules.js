...
<Text style={{fontSize:50, fontWeight:'bold', padding:20}}>   Fake-nutrinet   </Text>

    <Text style={{fontSize:20, fontWeight:'bold', padding:10, color:"red"}}>   Régles de confidentialité :   </Text>
    <Text>  
